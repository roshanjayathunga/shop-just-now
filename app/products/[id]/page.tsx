          ...
          <div className="flex flex-col">
            ...
            <div className="mt-4">
              ...
              {product.inventory <= 5 && product.inventory > 0 && (
                <p className="text-sm text-orange-500 mt-1">Only {product.inventory} left in stock</p>
              )}
              {product.inventory === 0 && <p className="text-sm text-red-500 mt-1">Out of stock</p>}
            </div>
